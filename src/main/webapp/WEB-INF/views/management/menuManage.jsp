<nav class="navbar navbar-default top-navbar" role="navigation">
	<div class="navbar-header">
		...
		<a class="navbar-brand waves-effect waves-dark" href="indexManage.do"><i
			class="large material-icons">track_changes</i> <strong>Manager</strong></a>
...
<ul id="dropdown4" class="dropdown-content dropdown-tasks w250 taskList">
	<li>
		<div>
			<strong>JAEGONG</strong> <span class="pull-right text-muted">
				<em>Today</em>
			</span>
		</div>
	...
	<div class="sidebar-collapse">
		<ul class="nav" id="main-menu">
			...
			<li><a class="active-menu waves-effect waves-dark"
				href="indexManage.do"><i class="fa fa-dashboard"></i> HOW ABOUT</a></li>
			<li><a href="uielements.do" class="waves-effect waves-dark"><i
					class="fa fa-desktop"></i> UI Elements</a></li>
			<li><a href="chart.do" class="waves-effect waves-dark"><i
					class="fa fa-bar-chart-o"></i> Charts</a></li>
			<li><a href="tabpanel.do" class="waves-effect waves-dark"><i
			...
			<li><a href="empty.do" class="waves-effect waves-dark"><i
