		...
		<nav class="navbar navbar-default top-navbar" role="navigation">
			<div class="navbar-header">
				...
				<a class="navbar-brand waves-effect waves-dark" href="indexManage.do"><i
					class="large material-icons">track_changes</i> <strong>HOWABOUT</strong></a>
			...
			<div class="sidebar-collapse">
				<ul class="nav" id="main-menu">
					...
					<li><a class="active-menu waves-effect waves-dark"
						href="indexManage.do"><i class="fa fa-dashboard"></i> Dashboard</a></li>
					<li><a href="ui-elements.do" class="waves-effect waves-dark"><i
					...
					<li><a href="tab-panel.do" class="waves-effect waves-dark"><i
